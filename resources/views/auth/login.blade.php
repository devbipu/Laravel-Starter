            ...
            <div class="hidden w-full xl:block xl:w-1/2">
              <div class="px-26 py-17.5 text-center">
                <a class="mb-5.5 inline-block" href="index.html">
                  <img src="/images/brand/sitelogo.svg" alt="" srcset="">
                </a>
              ...
              <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mb-4">                    
                    ...
                    <div class="relative">
                        <x-text-input id="email" class="block w-full mt-1" placeholder="Enter Your Email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                  ...
                  <div class="mt-6 text-center">
                    <p class="font-medium">
                      ...
                      <a href="signup.html" class="text-primary">Reset Now</a>
                    </p>
                  </div>
                </form>
              </div>
