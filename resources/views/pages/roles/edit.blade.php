            ...
            <div class="relative flex flex-col py-8 pt-6 break-words max-w-96 ">
                <form action="{{ route('role.update', $role->id) }}" method="POST">
                    ...
                    <div class="flex flex-col gap-5.5">
                        ...
                        <div x-data="{ switcherToggle: @json($role->status ? true : false) }">
                            <label for="toggle1" class="flex items-center gap-2 cursor-pointer select-none">
                                <div class="relative">
                                    <input type="checkbox" id="toggle1" name="status"
                                        :value="switcherToggle ? 1 : 0" class="sr-only"
                        ...
                        <div>
                            <x-primary-button class="px-2 py-2">Update</x-primary-button>
                        </div>
                    </div>
                </form>
            </div>
