<x-app-layout>
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6 2xl:p-10">
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form action="{{ route('permissions.update', $permission->id) }}" method="POST" class="p-6.5">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-3 place-items-stretch gap-5.5 ">
                    <div>
                        <x-form.input-box name="name" label="Module Name" :value="$permission->name" :messages="$errors->get('name')"
                    ...
                    <div class="col-span-2">
                        <textarea name="actions" label="Module Actions"
                            ...
                            spellcheck="false" placeholder="read, create, update, delete">{!! implode(', ', array_keys($permission->values)) !!}</textarea>
