            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        <span class="block text-sm font-medium text-black dark:text-white">{{ $user->first_name }}
                            {{ $user->last_name }}</span>
                        <span class="block text-xs font-medium">{{ $user->employee_id }}</span>
                    </span>
                    ...
                    <span class="w-12 h-12 rounded-full">
                        @if ($user->avater_id)
                            <img src="/images/user/user-01.png" alt="User" />
                        @else
                            @svg('heroicon-o-user-circle', 'w-10 h-10')
                        @endif
                    </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-utils.nav-link :href="route('logout')"
